...
"""
@File       :   plot_eegvggcorrs_stats_trained_vs_untrained.py
@Author     :   Zitong Lu
...
X, Y = np.meshgrid(x, y)
plt.contour(X, Y, newp, (-0.5, 0.5), cmap="bwr", linewidths=4)

fig = plt.gcf()
fig.set_size_inches(8, 4)
plt.imshow(t, extent=(0, 2.952, 0, 1.76), clim=(-6, 6), origin='low', cmap="coolwarm")
